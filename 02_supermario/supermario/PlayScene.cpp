...
{
	if (m_pPlayer->m_currentScene != SCENE_PLAY) {
		m_pPlayer->SceneInit(SCENE_PLAY, m_charPos.x, m_charPos.y, true, m_pPlayer->m_CharLevel, false);
...
void PlayScene::Render(HDC memDC, HDC backMemDC)
{
...
HBITMAP PlayScene::ImageLoad(LPCWSTR path, int width, int height)
{
	return (HBITMAP)LoadImage(NULL, path, IMAGE_BITMAP, width, height, LR_LOADFROMFILE);
}

void PlayScene::LoadImg(LPCWSTR path, int width, int height)
{
}

void PlayScene::InitMapData()
{
	for (int i = 0; i < m_MapSize.y; ++i) {
		for (int j = 0; j < m_MapSize.x; ++j) {
			m_Map[i][j] = 0;
...
bool PlayScene::CheckCollision(Object * object)
{
	// 플레이어 충돌처리
...
int PlayScene::CheckCollisionTop(Object * object)
{
	POINT tempPoint;
	RECT tempRect;
	RECT tempCollRect;
...
int PlayScene::CheckCollisionBottom(Object * object)
{
	POINT tempPoint;
	RECT tempRect;
	RECT tempCollRect;
...
int PlayScene::CheckCollisionLeft(Object * object)
{
	POINT tempPoint;
	RECT tempRect;
	RECT tempCollRect;
...
int PlayScene::CheckCollisionRight(Object * object)
{
	POINT tempPoint;
	RECT tempRect;
	RECT tempCollRect;
...
void PlayScene::CollisionTop(Object * object)
{
	object->m_Gravity = 0;
	object->m_DirTopBottom = 0;
}

void PlayScene::CollisionBottom(Object * object)
{
	object->m_state = 0;
	object->m_Gravity = 0;
...
void PlayScene::CollisionLeft(Object * object)
{
	switch (object->m_ObjectType)
	{
	case 0:
...
void PlayScene::CollisionRight(Object * object)
{
	switch (object->m_ObjectType)
	{
	case 0:
...
void PlayScene::NoCollisionTop(Object * object)
{

}

void PlayScene::NoCollisionBottom(Object * object)
{
	if (!object->m_state) object->m_state = true;
}

void PlayScene::NoCollisionLeft(Object * object)
{
	object->m_canLeft = true;
}

void PlayScene::NoCollisionRight(Object * object)
{
	object->m_canRight = true;
}

bool PlayScene::CheckCollisionObject(Object * object, list<Object*>* objectList)
{
	RECT tempRect;
...
bool PlayScene::CheckCollisionObject(list<Object*>* objectList)
{
	RECT temp;
...
bool PlayScene::CheckCollisionObject(list<Object*>* objectList, list<Object*>* objectList2)
{
	RECT tempRect;
	iter = objectList->begin();
